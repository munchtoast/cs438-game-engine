...
void BoxRigidBody::setA(float angle) {
  BoxRigidBody::getBoxProperties()->position.angle = angle;
}
...
void BoxRigidBody::setVY(float vely) {
  BoxRigidBody::getBoxProperties()->velocity.vy = vely;
}

float BoxRigidBody::getX() {
  return BoxRigidBody::getBoxProperties()->position.x;
}
float BoxRigidBody::getY() {
  return BoxRigidBody::getBoxProperties()->position.y;
}
float BoxRigidBody::getW() {
  return BoxRigidBody::getBoxProperties()->size.width;
}
float BoxRigidBody::getH() {
  return BoxRigidBody::getBoxProperties()->size.height;
}
float BoxRigidBody::getA() {
  return BoxRigidBody::getBoxProperties()->position.angle;
}
float BoxRigidBody::getVX() {
  return BoxRigidBody::getBoxProperties()->velocity.vx;
}
float BoxRigidBody::getVY() {
  return BoxRigidBody::getBoxProperties()->velocity.vy;
}
...
void BoxRigidBody::setBoxProperties(BoxBody::Box *ptr) { boxProperties = ptr; }
